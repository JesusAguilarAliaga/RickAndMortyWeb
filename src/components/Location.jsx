const Location = ({ endpoint }) => {
  ...
  return (
    <>
      <section className="z-30 mb-16 mt-8 w-[982px] col-span-2 h-[150px] border-2 border-green-main flex flex-col items-center justify-center gap-5 text-center max-lg:w-[435px] max-lg:mt-2 max-lg:mb-10 max-sm:w-[335px] max-lg:border-none max-lg:h-auto max-sm:mt-0">
