const SearchInput = ({ setValueSearch, setErrorNotification }) => {
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="z-30 mt-[430px]  w-[720px] h-14 border-2 border-green-main flex justify-between max-lg:w-[435px] max-sm:w-[350px] max-lg:mt-[250px] max-sm:mt-[210px]" action="">
